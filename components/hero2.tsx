...
export default function HomePage() {
  ...
  const buildingY = useTransform(
    scrollYProgress,
    [0, 0.5, 0.6],
    [0, 140, 140] // holds position briefly
  );

  const buildingX = useTransform(
    scrollYProgress,
    [0.6, 1],
    ["0%", "-40%"]
  );
  const smoothY = useSpring(buildingY, {
    stiffness: 80,
    damping: 25,
  });

  const smoothX = useSpring(buildingX, {
    stiffness: 80,
    damping: 25,
  });
  ...
  const smoothOpacity = useSpring(buildingOpacity, {
    stiffness: 80,
    damping: 25,
  });
  ...
  return (
    <div>
       <div className="fixed bottom-0 left-0 w-full h-screen overflow-hidden pointer-events-none z-[999]">
        <motion.div
          style={{ y: smoothY, x: smoothX, opacity: smoothOpacity }}
          className="absolute inset-0"
        >
          <Image
            src="/images/mob-build.png"
            alt="Building"
            fill
            className="object-cover block md:hidden object-[30%_55%]"
            priority
          />

          <Image
            src="/images/tab-build.png"
            alt="Building"
            fill
            className="hidden md:block lg:hidden object-cover object-[30%_55%]"
            priority
          />

          <Image
            src="/images/22.png" // your 1920x1080
            alt="Building"
            fill
            className="object-cover object-[30%_50%] hidden lg:block"
            priority
          />
        </motion.div>
      </div> 
      ...
      <div>
        ...
        <section ref={ref} className="relative h-[100vh] bg-black">
          <div className="relative z-20 h-[100dvh] flex items-center justify-center">

          <div className="relative z-20 h-[100dvh] flex items-start justify-start pt-20 md:pt-28 pl-4 md:pl-8 lg:pl-16">
            <div className="text-center md:text-left max-w-6xl mx-auto md:mx-0">
              <p className="hero-text1 text-black text-6xl md:text-6xl lg:text-9xl font-bold font-space">
                BUILD YOUR OWN
              </p>

              <p className="text-black text-xl md:text-xl font-jost">
          ...
          {/* HERO SECTION */}
           <div className="absolute top-0 left-0 w-full h-[100dvh] z-0 overflow-hidden">
            <Image
              src="/images/mob-back.jpg"
              alt="Background"
              fill
        ...
        <div className="h-[100dvh] flex items-center justify-center bg-black text-white text-5xl font-bold relative z-10">
          Next Section
        </div>
